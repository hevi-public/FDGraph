...
class GraphController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let node = [
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius * 1.1),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius * 1.4),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius * 1.2),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius * 1.3),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius * 1.1),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius * 1.5),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius * 1.6),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius * 1.5),
        Node(mass: mass, radius: radius),
        Node(mass: mass, radius: radius)
