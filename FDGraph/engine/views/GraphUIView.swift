...
struct GraphUIView: UIViewControllerRepresentable {
    ...
    @State var nodes: [Node] = [
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.2),
        Node(radiusMultiplier: 1.2),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.4),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.5),
        Node(radiusMultiplier: 1.4),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.6),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.2),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.7),
        Node(radiusMultiplier: 1.3),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.8),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.0),
        Node(radiusMultiplier: 1.5),
