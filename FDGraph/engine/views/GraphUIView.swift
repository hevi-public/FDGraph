...
struct GraphUIView: UIViewControllerRepresentable {
    ...
    func updateUIViewController(_ uiViewController: GraphController, context: UIViewControllerRepresentableContext<GraphUIView>) {
        ...
        self.nodeStore.nodes[6].parent = self.nodeStore.nodes[0]
        self.nodeStore.nodes[7].parent = self.nodeStore.nodes[0]
        self.nodeStore.nodes[8].parent = self.nodeStore.nodes[0]
        self.nodeStore.nodes[9].parent = self.nodeStore.nodes[0]
        
        self.nodeStore.nodes[11].parent = self.nodeStore.nodes[10]
        self.nodeStore.nodes[12].parent = self.nodeStore.nodes[10]
        self.nodeStore.nodes[13].parent = self.nodeStore.nodes[10]
        self.nodeStore.nodes[14].parent = self.nodeStore.nodes[10]
        self.nodeStore.nodes[15].parent = self.nodeStore.nodes[10]
        
        self.nodeStore.nodes[0].parent = self.nodeStore.nodes[20]
        self.nodeStore.nodes[10].parent = self.nodeStore.nodes[20]
